...
from api.endpoints import user, role, access, websocket, upload, category, pages, article, content, job, options

api_router = APIRouter(prefix="/api/v1")
api_router.post("/test/oath2", tags=["测试oath2授权"], include_in_schema=False)(test_oath2)
...
api_router.include_router(options.router, prefix='/admin', tags=["选项管理"])
